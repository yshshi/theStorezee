          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                book a storage service, or contact us for support. This includes:
              </p>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-600 mt-4 space-y-2">
                <li>Provide and improve our luggage storage services</li>
                <li>Process bookings and facilitate pickup/delivery</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-600 mt-4 space-y-2">
                <li>Saathi partners and storage location providers for service delivery</li>
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                We collect location data to provide pickup and delivery services. This includes:
              </p>
              <ul className="list-disc list-inside text-gray-600 mt-4 space-y-2">
                <li>Your current location for nearby storage options</li>
                <li>Pickup and delivery addresses</li>
                <li>Real-time tracking during luggage transport</li>
              </ul>
              <p className="text-gray-600 leading-relaxed mt-4">
                You can disable location services in your device settings, but this may limit 
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-600 mt-4 space-y-2">
                ...
                <li>Booking history: 3 years for service improvement</li>
